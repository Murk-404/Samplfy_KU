import tty from 'tty';
export { writeJSON } from '../fs/dist/spotifly-utils-fs.esm.js';
export { chunkify } from '../iterable/dist/spotifly-utils-iterable.esm.js';
import 'fs-extra';
import 'path';

/* Internalized from https://github.com/sindresorhus/yoctocolors/blob/main/index.js */
const hasColors = tty.WriteStream.prototype.hasColors(); // Intentionally not using template literal for performance.
